 ...
 * @param "currency" The currency code that applies to the account
 */
Accounts.prototype.update = function (organisation_id, account_number, name, classification, type, tax, currency, options, callback) {
  if (typeof options == 'function') {
    callback = options;
    options = {};
  }
  ...
  this.client.post('/core.account/update/' + this.account_id + '', body, options, function(err, response) {
    if (err) {
      return callback(err);
    }
 ...
 *
 */
Accounts.prototype.delete = function (options, callback) {
  if (typeof options == 'function') {
    callback = options;
    options = {};
  }
  ...
  this.client.get('/core.account/delete/' + this.account_id + '', body, options, function(err, response) {
    if (err) {
      return callback(err);
    }
